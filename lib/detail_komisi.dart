  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            const Text('Komisi Barang', style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            buildDisplayRow(
                "Harga Barang", data['harga_barang']?.toString() ?? '-'),
            ...
            buildDisplayRow("Komisi Hunter", data['komisi'][0]['komisi_hunter']?.toString() ?? '-'),
            buildDisplayRow("Tanggal Komisi", formatDate(data['komisi'][0]['tanggal_komisi'])),
          ],
        ),
      ),
    );
